...
public class ArrivalBoardListFragment extends ListFragment {
    ...
    public ArrayList<ArrivalBoard> getArrivalBoardsForSelectedStation(){
        ...
        ArrayList<ArrivalBoard> returnArrivalBoards = new ArrayList<ArrivalBoard>();
        Station station = StationManager.getInstance().getSelected();

        for(ArrivalBoard ab: station){
            returnArrivalBoards.add(ab);
            System.out.println(ab.getNumArrivals());
            System.out.println(ab.getTravelDirn());
            System.out.println(ab.getTravelDirn());
        }
        return returnArrivalBoards;
    }
